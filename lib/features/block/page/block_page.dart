...
import 'package:wow/features/block/widgets/block_person_card.dart';
                      ...
                      children: [
                        Expanded(
                          child: ListView.builder(
                            ...
                            itemCount: context.read<BlockBloc>().users.length, // Sample count
                            itemBuilder: (context, index) {
                              return UerBlockCard(
                                user: context.read<BlockBloc>().users[index],
                              );
                            },
                          ),
                        ),
