...
import '../bloc/destroy_account_bloc.dart';
import '../repo/destroy_account_repo.dart';

class DestroyAccount extends StatelessWidget {
  const DestroyAccount({super.key});

  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) =>
          DestroyAccountBloc(repo: sl<DestroyAccountRepo>()),
      child: BlocBuilder<DestroyAccountBloc, AppState>(
